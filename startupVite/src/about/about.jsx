    ...
    return (
        <main className='main'>
            ...
            <p>You business consists of seven stats. Your balance represents how much money you 
                ...
                The last stat is customers per day. This represents how many people, on average, are 
                paying your business. They do not all pay equally.</p>
            ...
            <p>Your stats are defined by day, but the completion of an event causes the next week to 
                complete. The graph on your business page is defined by months. Every hour you receive 
                a new event, with a maximum of three pending events at any given time. You can read and 
                make a decision for them any time you like. Time will not continue for your business 
                until you do.</p>
            <h2> Decisions: </h2>
